...
# ─────────────────────────────────────────────
# 키워드 정의 (이전에 직접 모아둔 전체 DB 데이터 분석 기반 최적화 버전)
# ─────────────────────────────────────────────

# [수정] 지자체 핵심 정책 단어(스마트시티, 실증사업, 특구 등) 추가
CENTRAL_KEYWORDS = ["AI 정책", "데이터센터", "양자컴퓨팅", "디지털전환", "인공지능 전략", "스마트시티", "스마트도시", "실증사업", "규제자유특구"]

# 1. 광역 지자체 (세종 포함, 누락되었던 '울산' 추가)
...
# [수정] 생태계, 거점, 딥테크 등 지역 기사 단골 단어 추가
FILTER_KEYWORDS = ["AI", "인공지능", "AX", "DX", "로봇", "데이터산업", "산업", "사업", "MOU", "디지털전환", "양자", "체결", "선정", "생태계", "거점", "딥테크"]

# [수정] 무조건 삭제 키워드 (여기에 기업명 있으면 정부와 대기업이 협력하는 B2G 기사도 무조건 삭제됨)
ECONOMY_KEYWORDS = ["증시", "주가", "상한가", "호황", "성장", "매수", "나스닥", "코스피",
                    "GDP", "금리", "환율", "실적", "수혜", "전망", "분석", "리포트",
                    "목표가", "강세", "약세", "투자권고", "증권", "외인", "기관"]

# [수정] 대기업/플랫폼 이름은 여기에 배치. (정부 관련 단어가 없으면 차단, 있으면 통과)
CORPORATE_KEYWORDS = ["출시", "선보여", "이벤트", "할인", "사전예약", "공개채용", "업데이트",
                      "이용권", "구독", "신제품", "출장 서비스", "솔루션 공급", "B2B", "CSP",
                      "기술력", "플랫폼", "서비스", "ET톡", "삼성", "LG", "SK", "KT", "네이버", "카카오"]
...
POLITICS_KEYWORDS = ["후보", "공약", "출마", "선거", "의원", "당선", "유세", "국회", "총선", "지선", "대선", "국힘", "민주당", "사설", "트럼프", "백악관", "총리", "성과",
                     "양향자", "하정우", "배경훈", "이재명", "머스크", "업스테이지", "류제명"]

# [수정] 진흥원, 테크노파크, 재단 등 지자체 사업을 대행하는 '공공기관' 단어 대거 추가
GOV_KEYWORDS = ["정부", "부처", "시청", "도청", "군청", "구청", "지자체", "공공", "국가", "공고",
                "과학기술정보통신부", "과기정통부", "중기부", "산업부", 
                "진흥원", "테크노파크", "공단", "재단", "연구원", "교육원", "NIA", "NIPA", "KDN"] + REGIONS
